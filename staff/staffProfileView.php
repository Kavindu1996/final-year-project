...
<head>
    ...
    <link rel="stylesheet" href="CSS/staffProfileViewNewStyle14.css">
...
<body>
    <div class="container">
        <div class="title">
            ...
            <button class="notice" type="button" name="submit" onclick="window.open('notice.php','_top');">Notice</button>
        </div>
        <!-- mobileview -->
        <div class="mobiletitle">
            <b>Staff Information</b>
        </div>
        <button class="mobilenotice" type="button" name="submit" onclick="window.open('notice.php','_top');">Notice</button>
        ...
        <div class="both">
            ...
            <div class="right">
                ...
                <button class="close" type="button" name="submit" onclick="window.open('staffList.php','_top');">Close</button>
            </div>
        </div>
    </div>
</body>
