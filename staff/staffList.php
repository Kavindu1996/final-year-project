...
<head>
    ...
    <link rel="stylesheet" href="CSS/staffListStyle15.css">
</head>
<body>
                        ...
                        while ($staff = mysqli_fetch_assoc($staffMembers)) {
                            ...
                            <tr>
                                ...
                                <td data-label="view profile">
                                    <!-- view profile -->
                                    <button type="button" id='addNew1' name="submit" onclick="window.open('staffProfileView.php?user_id=<?php echo $staff['id'];?>','_top');">
