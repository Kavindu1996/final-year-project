...
<head>
    ...
    <link rel="stylesheet" href="CSS/serviceStyle18.css">
</head>
<body>
    <main class="container">
        <div class="sub-section">
            <div class="headding">
                <span class ="button_Next_Text">Services</span>
            </div>
            ...
            <table class="masterlist">
                ...
                <tbody>
                    <?php
                        ...
                        if ($serviceType) {
                            //The records in the staffMembers is assigned to the staff variable as an associative array
