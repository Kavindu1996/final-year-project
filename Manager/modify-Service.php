...
<head>
    ...
    <link rel="stylesheet" href="CSS/modify-ServiceStyle2.css">
</head>
<body>
<div class="container">
    <div class="title">
                ...
                <div class="input_box_first">
                    <div class="firstLeft">
                        ...
                        <div class="inputColumnFirstLeft">
                            <input id="inputFirstName" type="text" name="name" placeholder="Name" <?php echo 'value="' . $name . '"'; ?>>
                        </div>
                    </div>
                    <div class="firstRight">
                        ...
                        <div class="inputColumnFirstRight">
                            <input id="inputLastName" type="text" name="description" placeholder="Description" <?php echo 'value="' . $description . '"'; ?>>
                        </div>
                    </div>
                </div>
            </div> 
                ...
                <div class="input_box_second">
                    <div class="secondLeft">
                        ...
                        <div class="inputColumnSecondLeft">
                            <input id="inputPhoneNumber" type="text" name="service_charge" placeholder="Service Charge" <?php echo 'value="' . $service_charge . '"'; ?>>  
                        </div>
                    </div>
                    ...
                    <div class="secondRight">
                        ...
                        <div class="inputColumnSecondRight">
                            <input id="inputLastName" type="text" name="duration" placeholder="Duration" <?php echo 'value="' . $duration . '"'; ?>>                         
                        </div>
                    </div>
                </div>
            </div> 
