...
if (isset($_GET['user_id'])) {
    ...
    if ($result_set) {
        if (mysqli_num_rows($result_set) == 1) {
            ...
            header('Location: appointment.php?user_not_found');
        }
    }else {
        header('Location: appointment.php?query_failed');
    }
}
...
if (isset($_POST['submit'])) {
    ...
    //validations
    $req_field = array('appointment_date', 'service', 'role');
...
<head>
    ...
    <link rel="stylesheet" href="CSS/existAddAppointmentStyle2.css">
</head>
...
<body>
    <div class="container">
        ...
        <form action="existAddAppointment.php" method="post" class="userform">
