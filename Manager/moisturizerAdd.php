                        ...
                        if (empty($errors)) {
                            ...
                            $result = mysqli_query($connection, $query);
                                ...
                                if ($result) {
                                    ...
                                    header('Location: moisturizing.php?moisturizer_added=true');
...
<head>
    ...
    <link rel="stylesheet" href="CSS/moisturizerAddStyle1.css">
</head>
<body>
    <div class="container">
        <div class="title">
            <div class="routing">Moisturizer / Add New Moisturizer</div>
            <b>Add New Moisturizer</b>
        </div>
        <!-- mobileview -->
        <div class="mobiletitle">
            <b>Add New Moisturizer</b>
        </div>
        <div class="mobilerouting">Moisturizer / Add New Moisturizer</div>
        ...
        <form action="moisturizerAdd.php" method="post" class="userform" enctype="multipart/form-data">
            <div class="user-details">
                ...
                <div class="button">
                    ...
                    <button type="button" class="back"  onclick="window.open('moisturizing.php','_top');">Back</button>
                </div>
