...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        ...
        if ($result) {
            header('Location: onlineCustomers.php?appointment_added=true');
        }else{
...
<head>
    ...
    <link rel="stylesheet" href="CSS/addAppointmentStyle4.css">
</head>
...
<body>
    <div class="container">
        ...
        <form action="addAppointment.php" method="post" class="userform">
