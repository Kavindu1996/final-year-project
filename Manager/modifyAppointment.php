...
<head>
    ...
    <link rel="stylesheet" href="CSS/modifyAppointmentStyle.css">
</head>

<body>
    <div class="container">
        <div class="title">
            <div class="routing">Appointment / Modify Appointment</div>
        ...
        <div class="mobilerouting">Appointment / Modify Appointment</div>
        <!--validation display-->
        ...
        ?>
        <form action="modifyAppointment.php" method="post" class="userform">
