...
<head>
    ...
    <link rel="stylesheet" href="CSS/dailyIncomeStyle8.css">
            ...
            <div class="headding">
                <span class ="button_Next_Text">Daily Incomes</span>
                    ...
                    <form action="" method="GET">
                        <div class="filter">
                            <div class="fromDate">      
                                <input type="date" name="from_date" id="from_date" value ="<?php echo $from_date; ?>" class="form-control" placeholder="From Date" />  
                            </div>  
                            <div class="toDate">  
                                <input type="date" name="to_date" id="to_date" value ="<?php echo $to_date; ?>" class="form-control" placeholder="To Date" />  
                            </div>  
                    ...
                    <form action="" method="GET">
                        <div class="mobileview-filter">
                            ...
                            <div class="toDate">  
                                ...
                                <input type="date" name="to_date" id="mobileview-to_date" value ="<?php echo $to_date; ?>" class="form-control" placeholder="To Date" />  
                            </div>  
                ...
                <tbody>
                    <?php
                        ...
                        if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                            ...
                            if ($result_set) {
                                while($date = mysqli_fetch_assoc($result_set))
                            {
                    ?>
                                <tr>
