    ...
    if (isset($_GET['equipment_id'])) {
        ...
        if ($result_set) {
            if (mysqli_num_rows($result_set) == 1) {
                ...
                header('Location: equipment.php?Equipment_not_found');
            }
        }else {
            header('Location: equipment.php?query_failed');
        }
    }
                    ...
                    if (empty($errors)) {
                        ...
                        $result = mysqli_query($connection, $query);
                            ...
                            if ($result) {
                                ...
                                header('Location: equipment.php?equipment_modified=true');
...
<head>
    ...
    <link rel="stylesheet" href="CSS/modify-stockReportEquipment2.css">
</head>
<body>
    <div class="container">
        <div class="title">
        ...
        <input type="hidden" name="equipment_id" value="<?php echo $equipment_id; ?>">    
            <div class="user-details">
                ...
                <div class="button">
                    ...
                    <button type="button" class="back"  onclick="window.open('equipment.php','_top');">Back</button>
                </div>
            </div>
        </form>
    </div>
