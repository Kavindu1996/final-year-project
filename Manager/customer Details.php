...
<?php
   ...
   if (!isset($_SESSION['manager_id'])) {
    ...
    if (isset($_GET['date'])) {
        ...
        $query = "SELECT * FROM appointment INNER JOIN customer ON appointment.phone_number = customer.phone_number AND appointment.is_deleted = '0' ORDER BY appointment_date;";
    }
