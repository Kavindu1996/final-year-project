...
if (isset($_GET['phone_number'])) {
    ...
    if ($result_set) {
        if (mysqli_num_rows($result_set) == 1) {
            ...
            header('Location: existAddAppointment.php?user_not_found');
        }
    }else {
        header('Location: existAddAppointment.php?query_failed');
    }
}
...
<head>
    ...
    <link rel="stylesheet" href="CSS/existAddAppointmentStyle.css">
</head>
